...
// taks 1
// Add new action types in ActionTypes.js to support adding, loading, and the failed loading of partners information.
export const ADD_PARTNERS = 'ADD_PARTNERS';
export const PARTNERS_LOADING = 'PARTNERS_LOADING';
export const PARTNERS__FAILED = 'PARTNERS__FAILED';